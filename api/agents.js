export default async function handler(req, res) {
  ...
  if (messages && messages.length > 0) {
    ...
    const prompts = {
      ...
      // NEW AGENTS
      audit: `You are an AI creator auditor. Analyze @${a.handle}:\nFollowers: ${a.followers}. Engagement: ${a.engagement_rate}%. Posts: ${a.total_posts}.\nTop posts:\n${posts}\nNiche: ${niche}. ${pc}\nGenerate a comprehensive creator audit with:\n1. STRENGTHS (2-3 points)\n2. WEAKNESSES (2-3 points)\n3. BEST PERFORMING CONTENT TYPE\n4. GROWTH OPPORTUNITIES (3 specific)\n5. NEXT BEST ACTIONS (3 immediate steps)\nBe specific, data-driven, and actionable.`,
      opportunities: `Creator: @${a.handle} (${niche}). Followers: ${a.followers}. Engagement: ${a.engagement_rate}%.\n${pc}\nTrending: ${tr}.\nPosts:\n${posts}\nGenerate opportunities in these sections:\n1. TRENDING OPPORTUNITIES (3 ideas based on current trends)\n2. CONTENT GAPS (3 untapped angles)\n3. AUDIENCE PAIN POINTS (3 problems your audience faces)\n4. CONTENT SERIES IDEAS (2 series with 5 episode ideas each)\nMake everything specific to ${niche} and their audience.`,
